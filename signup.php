<html>
<head>
    <title>Signup | SIGNATURE MOMENTS HAIR SALON AND SPA </title>
  </head>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Signature moments hair salon</a>
        </div>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest, <br> Welcome to <span class="edit"> Signature Moments hair salon </span></h1>
     <br>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <form role="form" action="registrationsuccess.php" method="POST">
